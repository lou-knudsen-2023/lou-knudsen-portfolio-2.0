...
This repo is designed to provide space to code a fullstack app. It contains node modules and folders for databases, routes, api requests, and react components.

## Setup

To install some add ons....
- To add material UI : npm install @mui/material @mui/styled-engine-sc styled-components
- If you want to add redux back in: (https://redux.js.org/introduction/installation)
